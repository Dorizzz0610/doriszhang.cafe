            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="modern-card p-6 animate-slideInRight">
                ...
                <p className="mb-4 text-gray-800 dark:text-gray-200">
                  Hi! I&apos;m a first year PhD student at HKUST CSE <span className="line-through">final year Undergraduate student at HKUST CSE with minor in Business</span> <Link href="/graduation" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 underline transition-colors">(I have graduated!🥳)</Link>
                </p>
