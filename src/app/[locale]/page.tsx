          ...
          <section className="flex flex-col md:flex-row gap-16 items-center md:items-start mb-20 animate-fadeIn">
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="flex flex-col gap-3 mb-10">
                {/* Row 1: Email + WeChat + Instagram */}
                <div className="flex flex-wrap gap-4">
                  <a href="mailto:lzhangcx@connect.ust.hk" className="btn-outline flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    Email
                  </a>
                  <WeChatButton wechatId="itsurroadmovie" className="btn-outline flex items-center gap-2" />
              ...
              <div className="modern-card p-6 animate-slideInRight">
                ...
                <p className="mb-4 text-gray-800 dark:text-gray-200">
                  ...
                  , <span className="line-through">final year undergraduate student in Computer Science, with minor in Business, at HKUST</span>{' '}
                  <Link
                    href="/graduation"
                ...
                <p className="text-gray-800 dark:text-gray-200">
                  ...
                  <a
                    href="https://xmouyang.github.io/Team/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 underline transition-colors"
                  >
                  ...
                  , I&apos;m currently interested in AI-enhanced IoT systems and their applications, with the sense of making AI more accessible to daily activities.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-8">
              <div className="modern-card p-6 hover:shadow-xl transition-all duration-500">
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full bg-yellow-100 dark:bg-yellow-900 flex-shrink-0">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-1">PhD in Computer Science and Engineering</p>
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">Aug. 2025 – Aug. 2029 (expected)</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 21V8l8-5 8 5v13" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 21v-9h6v9" />
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full bg-green-100 dark:bg-green-900 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h18" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16.5 3 21 7.5m0 0L16.5 12M21 7.5H3" />
                    </svg>
                  </div>
                  <div className="flex-grow">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253" />
            ...
            <div className="modern-card p-6">
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Third Prize in Tencent Cloud Track - AdventureX (2025)</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mr-3 mt-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span>Excellence Prize in Amazon Kiro Track - AdventureX (2025)</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mr-3 mt-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-4">
              <div className="modern-card p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">COMP4901D Embedded AI Systems (2026 Spring)</p>
                </div>
              </div>
